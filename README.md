...
6. ✅ الروابط والصور
   ...
   - الصور وصور GIF
7. ✅ الفيديو والصوت
   - فيديو مع خصائص poster و controls
   - صوت مع خصائص preload و muted
8. ✅ التضمين (iframe, embed)
   - تضمين مواقع خارجية
   - تضمين فيديو يوتيوب
9. ✅ القوائم
   - قوائم مرتبة (ol)
   - قوائم غير مرتبة (ul)
   - قوائم وصفية (dl)
10. ✅ عناصر التفاصيل / الملخص
    - details و summary
11. ✅ النماذج (Forms)
    - حقول النص، البريد، كلمة السر
    - مربعات الاختيار (checkbox)
    - أزرار الراديو (radio)
    - textarea
    - أزرار الإرسال (submit) والإعادة (reset)
12. ✅ عناصر التنسيق
    - hr و br
13. ✅ أنواع العناصر
    - Block مقابل Inline
...
14. ✅ خصائص العرض
    - display
    - visibility
15. ✅ وسوم قديمة وغير مفضلة (Deprecated)
16. ✅ ملاحظات هامة
```
